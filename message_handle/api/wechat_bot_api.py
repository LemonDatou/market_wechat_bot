...
def test_send_msg(test_port):
    post_wechat_http_api(APIS.WECHAT_LOG_START_HOOK)
    if post_wechat_http_api(APIS.WECHAT_IS_LOGIN)["is_login"] == 1:
        print(post_wechat_http_api(APIS.WECHAT_GET_SELF_INFO))
        ...
        post_wechat_http_api(APIS.WECHAT_MSG_SEND_CARD,data = data)
        ...
        post_wechat_http_api(APIS.WECHAT_MSG_SEND_FILE,data = data)
        ...
        data = {"wxid":'filehelper',
                ...
                "img_path":""}
        post_wechat_http_api(APIS.WECHAT_MSG_SEND_ARTICLE,data = data)
        print(post_wechat_http_api(APIS.WECHAT_CONTACT_GET_LIST))
        data = {"wxid":"filehelper"}
        print(post_wechat_http_api(APIS.WECHAT_CONTACT_CHECK_STATUS,data = data))
    post_wechat_http_api(APIS.WECHAT_LOG_STOP_HOOK)
...
def test_get_chatroom_list_from_db(test_port):
    dbs = post_wechat_http_api(APIS.WECHAT_DATABASE_GET_HANDLES)
    ...
    res = post_wechat_http_api(APIS.WECHAT_DATABASE_QUERY,data = data)
    return res['data']
